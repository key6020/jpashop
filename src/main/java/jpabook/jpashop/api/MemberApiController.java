...
public class MemberApiController {
    ...
    public Result<List<MemberDto>> memberV2() {
        ...
        List<MemberDto> collection = members.stream().map(m -> new MemberDto(m.getName())).collect(Collectors.toList());
    ...
    public CreateMemberResponse saveMemberV2(@RequestBody @Valid CreatedMemberRequest request) {
